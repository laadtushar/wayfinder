// ============================================================================
// Wayfinder fork of URP TerrainLitPasses.hlsl
...
// single _REGOLITH_DETAIL injection in SplatmapFragment (search "Wayfinder:").
...
#endif
{
    ...
    // Wayfinder: near-field regolith detail. Injected AFTER the splat/basepass
    // #endif so it is path-agnostic (both branches declare albedo/normalTS),
    // and BEFORE InitializeInputData so the blended normalTS feeds the
    // per-pixel-normal tangent-to-world reconstruction. Off-variant is
    // byte-for-byte stock TerrainLit.
